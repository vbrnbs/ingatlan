<template>
  <div class="list col-xs-12 col-lg-9 px-4">
    ...
    <div class="mt-3">
      <!-- lista elem -->
      <div v-for="ad in ads" :key="ad.address" class="ingatlan d-flex bg-white my-2">
        <!-- ingatlan-kép -->
